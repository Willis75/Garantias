    		    ...
    		    include 'conect_gar.php';
                            ...
                            if (!$resultado) {
    			             printf("error: %s\n", $mysqli->error);
                                ...
                                ,"<tr><th>Folio</h><th>Sucursal</th><th>Estatus</th><th>Cliente</th><th>Producto</th><th>Línea</th><th>Canalización</th><th>Inicio</th><th>Revisión sucursal</th><th>Fecha dictamen</th><th>Entrega dictamen</th><th>Entrega producto</th><th>Procede</th><th>Aplica</th><th>Cierre</th><th>Dias</th><th>Adjunto</th></tr>";
