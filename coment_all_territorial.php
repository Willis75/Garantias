        ...
        <div class="container-fluid">
          ...
          <div>
            <ul class="nav navbar-nav">
              <li><a href="intro_admin_territorial.php">Inicio</a></li>
		...
		<div id="nvo_coment">
                        ...
                        if($asoc['gar_dictam']==1 && $insert['fecha_dictamen'] == NULL && $insert['TOP'] != 1 && $insert['dic_suc'] != 1 ){
                            echo "<br><div id='dictamen'>
                                    <form action='add_dictamen.php' method='post' enctype='multipart/form-data'>
                                        ...
                                        <input class='enviar' id='enviar_dictamen' type='submit' value='Enviar' />
                                    </form>
                                </div>";
                        }
                    ...
                    <div id="datos">
                        ...
                        <center><h2>Datos del folio</h2></center>
                            ...
                            /*$resultado=$mysqli->query("SELECT email, email_jefe FROM asoc WHERE usuario ='$asignado'");
                            if ( false==$resultado) {
                                printf("error: %s\n", mysqli_error($mysqli));
                            }else{
                                //print_r($datos);
                            ...
                            $_SESSION['$correo_usuario']= $insert['email'];
                            if($fila['email_jefe']!=NULL){
                                $_SESSION['$correo_asignado']= $fila['email'].", ".$fila['email_jefe'];
                            }else{
                                $_SESSION['$correo_asignado']= $fila['email'];
                            }*/
